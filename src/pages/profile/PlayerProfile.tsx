        ...
        <div className="max-w-3xl mx-auto p-2">
          ...
          <form onSubmit={handleUpdate} className="space-y-4 md:space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                className={`w-full border-2 p-4 md:p-5 rounded-3xl h-32 focus:border-blue-500 outline-none transition-all italic text-sm md:text-base ${
                  about.length > 500 ? "border-red-500" : "border-gray-100"
                }`}
                value={about}
